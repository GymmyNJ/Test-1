...
// Prefer /public; fall back to project root if files were uploaded flat
...
app.get('/', (req, res) => {
  ...
  if (!fs.existsSync(index)) {
    return res.status(500).send(
      'index.html not found. On GitHub, either keep files inside a public/ folder ' +
      'or place index.html next to server.js.'
    );
  }
  res.sendFile(index);
});
